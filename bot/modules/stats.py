...
async def bot_stats(_, message):
    ...
    stats = f"""
<b>Commit Date:</b> {commands.get("commit", "N/A")}
...
<b>python:</b> {commands.get("python", "N/A")}
<b>aria2:</b> {commands.get("aria2", "N/A")}
<b>rclone:</b> {commands.get("rclone", "N/A")}
<b>yt-dlp:</b> {commands.get("yt-dlp", "N/A")}
<b>ffmpeg:</b> {commands.get("ffmpeg", "N/A")}
<b>7z:</b> {commands.get("7z", "N/A")}
"""
...
async def get_packages_version():
    ...
    for tool, version in zip(list(commands.keys()), versions):
